...
매일 오전 7:30 KST에 전일자 AI 동향 요약 보고서가 자동 생성됩니다.

## 📋 보고서 구조

매일 보고서는 다음 5+1블록으로 구성:

1. **🎯 오늘의 한 줄** — 안 읽어도 핵심 파악
2. **⭐ 핵심 변화 TOP 3** — 무슨 일/왜 중요/너에게 영향
3. **🔶 Anthropic / Claude Code 깊이 분석** — 가장 큰 비중
4. **🟢 Major AI** — OpenAI · Google · Meta
5. **🟡 Rising AI** — Manus · xAI · DeepSeek 등
6. **🔬 트렌드 한 컷** — 비유로 풀어 설명
7. **💡 활용 아이디어** — 15분/1시간/하루 단위 액션
8. **📎 출처** — 모든 주장에 URL
...
| 2026-07-21 | [전일 동향](./2026-07-21.md) | OpenAI 장기 에이전트 안전 논문(궤적 모니터링)·DeepSeek V4 GA 정식출시+7/24 레거시 모델명 은퇴·Grok 4.6 2T 훈련 완료 임박 |
| 2026-07-20 | [전일 동향](./2026-07-20.md) | Fable 5 영구 플랜(Max·Team Premium) + Claude Code 한도 8/19까지 연장·Qwen 3.8 Max 2.4T WAIC 발표·v2.1.215 /verify 자동실행 제거 |
...
| 2026-06-23 | [전일 동향](./2026-06-23.md) | GPT-5.6 출시 창 D+1(출시 없음·Polymarket 90%)·Google Gemini Managed Agents 공개 프리뷰(서버 없이 에이전트 배포)·ChatGPT 점유율 사상 첫 50% 이하 |
...
| 2026-06-21 | [전일 동향](./2026-06-21.md) | Agentjacking(Sentry 가짜 버그 리포트로 Claude Code·Cursor·Codex 2,388개 기업 해킹 실증)·GPT-5.6 스텔스 테스트 에스컬레이션(Polymarket 89%·6/25 출시 임박)·노르웨이 초등 AI 준금지+Musk "AI 랭킹: Anthropic 1위·xAI 5위" 증언 |
...
| 2026-06-15 | [전일 동향](./2026-06-15.md) | G7 전야 AI 지정학 격상(카니 경고·CEO 3인방 오찬)·Anthropic 빌링 6/15 분리·GLM 5.2 오픈웨이트 출시 |
| 2026-06-14 | [전일 동향](./2026-06-14.md) | 미국 상무부 Fable 5·Mythos 5 전면 차단(수출 통제 선례)·GPT-5.2 삭제·OpenAI IPO 2027 지연 신호 |
...
- **소스 우선순위**: Linkup → WebSearch (폴백)
- **공식 출처 직접 fetch**: anthropic.com/news, platform.claude.com/release-notes, ai.google.dev/changelog 등
- **검증 원칙**: 모든 주장에 URL 첨부, 추측은 [unverified] 태그
- **저장 위치**: `~/Desktop/Claude-Core/ai-daily-report/YYYY-MM-DD.md`

## 🔧 수동 실행

자동 실행이 누락되거나 즉시 보고가 필요하면:
```
claude
> "오늘 AI 일일 보고서 작성해줘"
```
